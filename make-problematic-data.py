...
import numpy as np
gut_sample = tab.data(gut.index[3], dense=False) / 2
skin_sample = tab.data(skin.index[3], dense=False) / 2
oral_sample = tab.data(oral.index[3], dense=False) / 2
vaginal_sample = tab.data(vaginal.index[3], dense=False) / 2
